...
public class AssetBatchStatementSetter implements BatchPreparedStatementSetter {

    private List<Asset> assets;

    public AssetBatchStatementSetter(List<Asset> assets) {
        this.assets = assets;
    }
    ...
    public void setValues(PreparedStatement ps, int i) throws SQLException {
        ...
        Asset entity = this.assets.get(i);
